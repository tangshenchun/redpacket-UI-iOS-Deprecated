...
- (RPRedpacketModel *)messageModel {
    ...
    NSString *money = rpString(@"%.2f", ((NSNumber *)info[@"Amount"]).floatValue);
    NSString *greeting = info[@"Greeting"];
    _messageModel = [RPRedpacketModel generateSingleRedpacketInfo:RPRedpacketTypeAmount receiver:self.receiver  redpacketMoney:money andGreeting:greeting];
