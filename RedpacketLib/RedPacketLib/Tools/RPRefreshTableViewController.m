//
//  RPRefreshTableViewController.m
//  ChatDemo-UI3.0
//
...
@interface RPRefreshTableViewController ()

@property (nonatomic, readonly) UITableViewStyle style;

@end

@implementation RPRefreshTableViewController
...
- (void)setShowRefreshHeader:(BOOL)showRefreshHeader
{
    if (_showRefreshHeader != showRefreshHeader) {
        ...
        if (_showRefreshHeader) {
            __weak RPRefreshTableViewController *weakSelf = self;
