...
@property (nonatomic,copy)NSArray<RPUserInfo *> * memberList;                   //专属红包可领取的人
...
@property (nonatomic,assign)RPRedpacketType redPacketType;                      //红包类型
@property (nonatomic,copy)NSString * congratulateTittle;                        //祝福语
@property (nonatomic, weak) RPUserInfo *conversationInfo;                       //当前用户 或者 当前群
...
@property (nonatomic,assign ,readonly)RPRedpacketType cacheRedPacketType;       //切换专属红包需要缓存当前红包状态
@property (nonatomic,assign ,readonly)BOOL submitEnable;                        //提交按钮是否可用
@property (nonatomic,strong ,readonly)RPRedpacketModel * messageModel;
